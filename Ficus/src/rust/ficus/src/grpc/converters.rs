...
fn convert_to_grpc_histogram_data(data: &HistogramData) -> GrpcGeneralHistogramData {
  GrpcGeneralHistogramData {
    ...
    entries: data.entries().iter().map(|e| GrpcGeneralHistogramEntry {
