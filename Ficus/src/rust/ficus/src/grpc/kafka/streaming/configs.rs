...
use crate::grpc::kafka::streaming::processors::{DefaultStreamingProcessor, TracesProcessor};
...
struct EventsTimeoutConfiguration { timeout_ms: u64 }
...
struct LossyCountConfiguration { error: f64, support: f64 }