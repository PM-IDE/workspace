...
use crate::grpc::kafka::streaming::t2::dfg_data_structures::{DfgDataStructures, LossyCountDfgDataStructures, SlidingWindowDfgDataStructures};
...
impl T2StreamingProcessor {
    pub fn new_sliding_window(element_lifetime: Duration) -> Self {
        Self {
            data_structure: Arc::new(Mutex::new(DfgDataStructures::SlidingWindow(SlidingWindowDfgDataStructures::new(element_lifetime))))
        }
    }
