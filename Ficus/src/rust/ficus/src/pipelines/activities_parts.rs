...
use crate::{
  ...
  features::analysis::{
    ...
    patterns::{
      activity_instances,
      activity_instances::{
        ActivitiesLogSource, ActivityInTraceInfo, AdjustingMode, SubTraceKind, UNDEF_ACTIVITY_NAME, UndefActivityHandlingStrategy,
  ...
  pipelines::{
    ...
    keys::context_keys::{
      ...
      ADJUSTING_MODE_KEY, DISCOVER_ACTIVITY_INSTANCES_STRICT_KEY, EVENT_CLASS_REGEX_KEY, EVENT_LOG_KEY, EVENTS_COUNT_KEY,
