use ficus::event_log::xes::{reader::file_xes_log_reader::read_event_log, writer::xes_event_log_writer::serialize_event_log};

use crate::test_core::{
  gold_based_test::execute_test_with_gold,
  test_paths::{create_example_log_gold_file_path, get_paths_to_example_logs},
};
