...
use chrono::Utc;
use core::fmt::Debug;
use ficus::event_log::core::{event::event::Event, event_log::EventLog, trace::trace::Trace};
...
fn test_simple_event_log_creation() {
    ...
    let simple_event_log = ficus::event_log::xes::simple::create_simple_event_log(&raw_log);
