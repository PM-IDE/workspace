...
export interface GrpcFrequenciesAnnotation_DONTUSE {
  'annotations'?: (_ficus_GrpcEntityFrequencyAnnotation_DONTUSE)[];
}

export interface GrpcFrequenciesAnnotation {
  'annotations': (_ficus_GrpcEntityFrequencyAnnotation)[];
}
