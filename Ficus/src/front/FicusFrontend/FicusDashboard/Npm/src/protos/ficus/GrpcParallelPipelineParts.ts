...
export interface GrpcParallelPipelineParts_DONTUSE {
  'pipeline'?: (_ficus_GrpcParallelPipelinePart_DONTUSE)[];
}

export interface GrpcParallelPipelineParts {
  'pipeline': (_ficus_GrpcParallelPipelinePart)[];
}
