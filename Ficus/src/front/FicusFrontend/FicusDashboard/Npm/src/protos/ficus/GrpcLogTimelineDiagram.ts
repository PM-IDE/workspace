...
export interface GrpcLogTimelineDiagram_DONTUSE {
  'traces'?: (_ficus_GrpcTraceTimelineDiagram_DONTUSE)[];
}

export interface GrpcLogTimelineDiagram {
  'traces': (_ficus_GrpcTraceTimelineDiagram)[];
}
