...
{
  public static void SetupContainerAndRun(
    string toplevelCommand, string[] args, Action<ContainerBuilder> configurationAdder, LogLevel logLevel = LogLevel.Information)
  {
